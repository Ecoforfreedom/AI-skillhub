            ...
            <div className="container" style={{ position: 'relative', zIndex: 2 }}>
              ...
              >
                ...
                <div className="hidden md:flex items-center gap-3 ml-auto lg:ml-0">
                  <Link href="/skills" className="sdv-btn" style={{ background: 'linear-gradient(180deg, rgba(244, 248, 255, 0.96) 0%, rgba(212, 224, 255, 0.92) 100%)', color: '#09111f' }}>
                    开始探索
                    <ArrowUpRight className="h-4 w-4" />
                  </Link>
                </div>

                <div className="flex items-center gap-2 ml-auto md:hidden" ref={searchRef}>
                  <button
                    type="button"
                    className="sdv-btn"
